...
namespace renderer {
    ...
    void Device::choosePhysicalDevice(VkInstance instance, VkSurfaceKHR surface) {
    ...
    void Device::createLogicalDevice(VkSurfaceKHR surface) {
        ...
        if (enableValidationLayers) {
            createInfo.enabledLayerCount = static_cast<uint32_t>(renderer::debug::validationLayers.size());
    ...
    VkFormat Device::getSupportedDepthFormat(bool checkSamplingSupport) const {
